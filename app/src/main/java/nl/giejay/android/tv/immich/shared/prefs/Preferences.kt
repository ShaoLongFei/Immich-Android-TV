...
// language
data object LANGUAGE : EnumByTitlePref<AppLanguage>(AppLanguage.SYSTEM,
    ImmichApplication.appContext!!.getString(R.string.language),
    ImmichApplication.appContext!!.getString(R.string.language_desc)) {
